...
prompt_virtualenv() {
  ...
  if [[ -n $env_label ]]; then
    color=magenta
    prompt_segment $color $CURRENT_FG
    print -Pn $env_label
  fi
}
...
__conda_setup="$('/Users/ilhambintang/opt/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/ilhambintang/opt/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/ilhambintang/opt/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/ilhambintang/opt/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
if [ -f '/Users/ilhambintang/Downloads/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/ilhambintang/Downloads/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/Users/ilhambintang/Downloads/google-cloud-sdk/completion.zsh.inc' ]; then . '/Users/ilhambintang/Downloads/google-cloud-sdk/completion.zsh.inc'; fi
